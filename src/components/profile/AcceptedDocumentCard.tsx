...
export default function AcceptedDocumentCard(props: Props) {
	const { documentType } = props;

	return (
		<Flex direction="column" w={"100%"} rounded="lg" overflow="hidden" borderColor="green.300" borderStyle={"solid"} borderWidth="1">
			<Box p="3" w={"100%"}>
				<Text
					fontSize="xs"
					fontWeight="500"
				...
				<HStack my={2} px={2}>
					<Center>
						<HStack space={2}>
							<Icon color={"green.300"} size="md" as={<MaterialIcons name="verified" size={24} />} />
							<Text fontSize="xs">Подтверждено</Text>
						</HStack>
					</Center>
					<Spacer />
