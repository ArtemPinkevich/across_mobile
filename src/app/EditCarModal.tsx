  ...
  return (
    <View style={styles.container}>
      <ScrollView mx={"2"}>
        ...
        <Checkbox value={'hasLiftgate'} isChecked={hasLiftgate} m={2} mt={4} onChange={o => setHasLiftgate(o)}>Гидролифт</Checkbox>
        <Checkbox value={'hasStanchionTrailer'} isChecked={hasStanchionTrailer} m={2} onChange={o => setHasStanchionTrailer(o)}>Коники</Checkbox>
        
        <FormControl my={4}>
          <FormControl.Label>Грузоподъемность, т</FormControl.Label>
				  <Input keyboardType='numeric' maxLength={3} variant="filled" size="md" placeholder="Грузоподъемность" value={carryingCapacity.toString()} onChangeText={o => setCarryingCapacity(+o)} />
          <Checkbox value={'hasLTL'} isChecked={hasLTL} m={2} onChange={o => setHasLTL(o)}>Догруз</Checkbox>
        </FormControl>
        
        <FormControl my={4}>
          <FormControl.Label>Объем кузова, м3</FormControl.Label>
          <Input keyboardType='numeric' maxLength={4} variant="filled" size="md" placeholder="Объем кузова" value={bodyVolume.toString()} onChangeText={o => setBodyVolume(+o)} />
          
          <FormControl.Label>Длина кузова, м</FormControl.Label>
          <Input keyboardType='numeric' maxLength={2} variant="filled" size="md" placeholder="Длина кузова" value={innerBodyLength.toString()} onChangeText={o => setInnerBodyLength(+o)} />
          
          <FormControl.Label>Ширина кузова, м</FormControl.Label>
          <Input keyboardType='numeric' maxLength={2} variant="filled" size="md" placeholder="Ширина кузова" value={innerBodyWidth.toString()} onChangeText={o => setInnerBodyWidth(+o)} />
          
          <FormControl.Label>Высота кузова, м</FormControl.Label>
          <Input keyboardType='numeric' maxLength={2} variant="filled" size="md" placeholder="Высота кузова" value={innerBodyHeight.toString()} onChangeText={o => setInnerBodyHeight(+o)} />
        </FormControl>
        
        <FormControl my={4}>
          <FormControl.Label>Разрешения</FormControl.Label>
          <Checkbox value={'tir'} isChecked={tir} m={2} onChange={o => setTir(o)}>TIR</Checkbox>
          <Checkbox value={'ekmt'} isChecked={ekmt} m={2} onChange={o => setEkmt(o)}>EKMT</Checkbox>
          <Checkbox value={'adr1'} isChecked={adr1} m={2} onChange={o => setAdr1(o)}>ADR-1, Взрывчатые материалы</Checkbox>
          <Checkbox value={'adr2'} isChecked={adr2} m={2} onChange={o => setAdr2(o)}>ADR-2, Сжатые газы</Checkbox>
          <Checkbox value={'adr3'} isChecked={adr3} m={2} onChange={o => setAdr3(o)}>ADR-3, Легковоспламен. жидкости</Checkbox>
          <Checkbox value={'adr4'} isChecked={adr4} m={2} onChange={o => setAdr4(o)}>ADR-4, Легковоспламен. вещества</Checkbox>
          <Checkbox value={'adr5'} isChecked={adr5} m={2} onChange={o => setAdr5(o)}>ADR-5, Окисляющиеся вещества</Checkbox>
          <Checkbox value={'adr6'} isChecked={adr6} m={2} onChange={o => setAdr6(o)}>ADR-6, Ядовитые вещества</Checkbox>
          <Checkbox value={'adr7'} isChecked={adr7} m={2} onChange={o => setAdr7(o)}>ADR-7, Радиоактивные вещества</Checkbox>
          <Checkbox value={'adr8'} isChecked={adr8} m={2} onChange={o => setAdr8(o)}>ADR-8, Едкие вещества</Checkbox>
          <Checkbox value={'adr9'} isChecked={adr9} m={2} onChange={o => setAdr9(o)}>ADR-9, Вещества с низкой опасностью</Checkbox>
        </FormControl>
